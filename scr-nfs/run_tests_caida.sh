...
PCAP_FOLDER_CL="cl_caida_64_scr"
PCAP_FOLDER_FW="fw_caida_64_scr"
PCAP_FOLDER_NAT="nat_caida_64_scr"
PCAP_FOLDER_SBRIDGE="sbridge_caida_64_scr"
PCAP_FOLDER_NOP="nop_caida_64_scr"
PCAP_FOLDER_PSD="psd_caida_64_scr"
PCAP_FOLDER_POL="pol_caida_64_scr"
...
run_balanced_bench_scr() {
	...
	local intermediate_results_file="$exp_dir/.caida.csv"
...
state_compute_replication() {
	...
	bench_balanced_nf_scr "sbridge-scr" "sbridge" "dpdk_sbridge_scr_" "$CURRENT_EXPERIMENT_DIR" "sbridge-scr-caida-64" $scr_gen
    bench_balanced_nf_scr "cl-scr" "cl" "dpdk_cl_scr_" "$CURRENT_EXPERIMENT_DIR" "cl-scr-caida-64" $scr_gen
	bench_balanced_nf_scr "fw-scr" "fw" "dpdk_fw_scr_" "$CURRENT_EXPERIMENT_DIR" "fw-scr-caida-64" $scr_gen
	bench_balanced_nf_scr "nat-scr" "nat" "dpdk_nat_scr_" "$CURRENT_EXPERIMENT_DIR" "nat-scr-caida-64" $scr_gen
	bench_balanced_nf_scr "nop-scr" "nop" "dpdk_nop_scr_" "$CURRENT_EXPERIMENT_DIR" "nop-scr-caida-64" $scr_gen
	# bench_balanced_nf_scr "psd-scr" "psd" "dpdk_psd_scr_" "$CURRENT_EXPERIMENT_DIR" "psd-scr-caida-64" $scr_gen
	bench_balanced_nf_scr "pol-scr" "pol" "dpdk_pol_scr_" "$CURRENT_EXPERIMENT_DIR" "pol-scr-caida-64" $scr_gen
}
