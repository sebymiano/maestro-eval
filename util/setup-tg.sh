...
sudo $MAESTRO_EVAL_DIR/build/dpdk/usertools/dpdk-hugepages.py --node 0 --reserve 42G
sudo $MAESTRO_EVAL_DIR/build/dpdk/usertools/dpdk-hugepages.py --node 1 --reserve 42G
