...
sudo $MAESTRO_EVAL_DIR/build/dpdk/usertools/dpdk-hugepages.py --node 0 --reserve 10G --pagesize 1G
sudo $MAESTRO_EVAL_DIR/build/dpdk/usertools/dpdk-hugepages.py --node 1 --reserve 10G --pagesize 1G
